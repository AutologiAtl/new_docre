...
class MSCExcelWriter:
    ...
    def write_to_excel(self, template_path, output_folder, processed_data,downloded_excel_path,uploaded_excel_path):
        ...
        try:
            ...
            vessel_and_voyage_no = processed_data.get('Vessel_No', 'Unknown') +  processed_data.get('Voyage_No', 'Unknown')
            ...
            # m3 , gross_weight = self.write_sheet_2(workbook)
            # Save and close the workbook
            # workbook.sheets[0].range('P34').value = gross_weight
            # workbook.sheets[0].range('T34').value = m3
            workbook.save()
